 ...
 * 
 */
exports.create = exports.createJob = function createJob() {

  //ensure queue
  exports.init();

  //create job
  const { attempts, backoff } = exports.options;
  const job = exports.queue.create.apply(exports.queue, arguments);
